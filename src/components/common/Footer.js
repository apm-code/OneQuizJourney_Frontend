...
function Footer() {
  return (
    <footer className="app-footer"> {/* Contenedor principal del footer */}
      <Container> {/* Contenedor de Bootstrap para centrar el contenido */}
        <Row className="align-items-center gy-2"> {/* Fila con alineación vertical centrada y pequeño espacio vertical */}

          {/* Columna izquierda */}
          <Col md={6}>
            <div className="footer-brand"> {/* Parte donde aparece el logo + nombre */}
            ...
            {/* Frase secundaria debajo del nombre */}
